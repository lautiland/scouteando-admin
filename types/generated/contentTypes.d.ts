...
export interface ApiAutorAutor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ColoresDeGrupo: Schema.Attribute.Component<'shared.color', true> &
      Schema.Attribute.Required &
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::autor.autor'> &
      Schema.Attribute.Private;
    NombreApodo: Schema.Attribute.String & Schema.Attribute.Required;
    NumeroDeGrupo: Schema.Attribute.Integer & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    Totem: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.Text;
    identificador: Schema.Attribute.UID & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categoria.categoria'
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nombreOApodo: Schema.Attribute.String & Schema.Attribute.Required;
    numeroDeGrupo: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
